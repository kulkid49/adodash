...
export function DashboardPage({ api }) {
    ...
    return (_jsxs(Stack, { spacing: 2, children: [_jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Employees Active Today" }), _jsx(Typography, { variant: "h5", fontWeight: 800, children: summary?.totalEmployeesActiveToday ?? "—" })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Tasks Closed Today" }), _jsx(Typography, { variant: "h5", fontWeight: 800, children: summary?.totalTasksClosedToday ?? "—" })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Total Estimated Hours" }), _jsx(Typography, { variant: "h5", fontWeight: 800, children: formatNumber(summary?.totalEstimatedHours) })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Total Actual Hours Logged" }), _jsx(Typography, { variant: "h5", fontWeight: 800, children: formatNumber(summary?.totalActualHoursLogged) })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Productivity %" }), _jsx(Typography, { variant: "h5", fontWeight: 800, children: summary?.productivityPercent == null ? "—" : `${formatNumber(summary.productivityPercent, 0)}%` })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Employees Below 8 Hours" }), _jsx(Typography, { variant: "h5", fontWeight: 800, color: "error", children: summary?.employeesBelow8Hours ?? "—" })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Employees Above 8 Hours" }), _jsx(Typography, { variant: "h5", fontWeight: 800, color: "warning.main", children: summary?.employeesAbove8Hours ?? "—" })] }) }) }), _jsx(Grid, { xs: 12, md: 3, children: _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "overline", children: "Average Efficiency" }), _jsx(Typography, { variant: "h5", fontWeight: 800, children: summary?.averageEfficiencyPercent == null
                                            ? "—"
